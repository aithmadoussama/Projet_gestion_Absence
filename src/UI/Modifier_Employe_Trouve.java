 ...
 * @author aithmad
 */
public class Modifier_Employe_Trouve extends javax.swing.JFrame {

    Chercher_Employe principal;

    /**
     * Creates new form ModifierEmployeRechPnl
     */
    public Modifier_Employe_Trouve(Chercher_Employe principal) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Modifier employe recherche");
    ...
    private void btnmodifieremploye2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodifieremploye2ActionPerformed
        ...
        if (new_nom.isEmpty() || new_departement.isEmpty() || new_poste.isEmpty()) {
            ...
            Employe e = principal.getEmptrouve();
            e.setNom(new_nom);
            ...
            if (choix == JOptionPane.OK_OPTION) {
                principal.principal.employeservice.updateEmplye(e);
                principal.principal.charger_Employe_Table();
